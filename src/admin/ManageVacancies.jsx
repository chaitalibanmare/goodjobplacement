...
export default function ManageVacancies() {
  ...
  const filteredVacancies = vacancies.filter(v =>
    (v.company_name || v.companyName || "").toLowerCase().includes(search.toLowerCase()) ||
            ...
            <tbody>
              ...
              {currentVacancies.map(v => (
                ...
                <tr key={v.id} style={{
                  ...
                  <td>
                    {new Date(v.posted_on || v.postedOn).toLocaleDateString()}
                  </td>

                  <td>
                    {new Date(v.last_date || v.lastDate).toLocaleDateString()}
                  </td>


                  <td>

                    {v.verification_status === "verified" || v.verificationStatus === "verified" ? (
                  ...
                  <td>
                    ...
                    <button
                      disabled={v.verification_status !== "verified" && v.verificationStatus !== "verified"}
                      onClick={() => toggleEnable(v.id)}
                      style={{
                        background: (v.verification_status !== "verified" && v.verificationStatus !== "verified")
                          ? "#9ca3af"
                          : "#7c3aed",
                        color: "white",
                        border: "none",
                    ...
                    >
                      {v.admin_enabled || v.adminEnabled ? "Disable" : "Enable"}
                    </button>
      ...
      {selectedVacancy && (
        ...
        <div style={{
          ...
          <div style={{
            ...
            <h2>{selectedVacancy.company_name || selectedVacancy.companyName}</h2>

            <p><b>Location:</b> {selectedVacancy.location}</p>

            <p><b>Field:</b> {selectedVacancy.field}</p>

            <p><b>Total Vacancies:</b> {selectedVacancy.total_vacancies || selectedVacancy.totalVacancies}</p>

            <p><b>Description:</b> <br />{selectedVacancy.description}</p>
